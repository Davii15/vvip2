...
import { Shield, Car, Home, Umbrella, Star } from "lucide-react"

export default function Loading() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-cyan-50 dark:from-slate-900 dark:to-slate-800 flex flex-col items-center justify-center">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-24 -right-24 w-64 h-64 bg-blue-300 rounded-full filter blur-3xl opacity-20"></div>
        <div className="absolute -bottom-32 -left-32 w-80 h-80 bg-cyan-300 rounded-full filter blur-3xl opacity-20"></div>
        ...
        >
          <Home className="h-9 w-9 text-blue-400" />
        </motion.div>
        ...
        >
          <Umbrella className="h-12 w-12 text-cyan-400" />
        </motion.div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <motion.h1
          ...
          className="text-3xl font-bold text-center mb-3 bg-gradient-to-r from-blue-500 to-cyan-600 text-transparent bg-clip-text"
        >
          Insurance Shop
        </motion.h1>
        ...
        >
          Finding the best insurance options to protect what matters most...
        </motion.p>
        ...
        <div className="relative">
          <motion.div
            ...
            className="h-1 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-full w-48"
          />
      ...
      <div className="container mx-auto px-4 mt-16 max-w-6xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 opacity-20">
          {[...Array(8)].map((_, i) => (
            ...
            >
              <div className="h-1/2 bg-gradient-to-r from-blue-200 to-cyan-200 dark:from-blue-800/50 dark:to-cyan-800/50" />
              <div className="p-4">
