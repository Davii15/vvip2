...
const getCategoryIconComponent = (category: string) => {
  switch (category) {
    ...
    case "City Explorations":
      return <Building className="h-4 w-4" />
    case "Desert Expeditions":
...
export default function TourismMediaShowcase() {
  useCookieTracking("tourism-media")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-amber-800 to-emerald-700">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-gradient-to-r from-emerald-900 to-amber-900 border-b border-emerald-700 shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <h1 className="text-2xl md:text-3xl font-bold text-amber-100">Tourism Adventures</h1>
      ...
      <div className="container mx-auto px-4 py-8" ref={containerRef}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVideos.map((video, index) => (
            <div
              key={video.id}
              className="relative bg-gradient-to-b from-emerald-900/90 to-amber-900/90 rounded-xl overflow-hidden shadow-xl border border-amber-600/30 backdrop-blur-sm"
              ref={(el) => {
        ...
        {isLoading && (
          <div className="flex justify-center items-center py-8">
            <div className="bg-emerald-900/80 p-4 rounded-full backdrop-blur-sm flex items-center gap-2">
