...
export default function AgricultureMediaShowcase() {
  useCookieTracking("agriculture-media")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-lime-800 to-green-700">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-gradient-to-r from-green-900 to-lime-800 border-b border-green-700 shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <h1 className="text-2xl md:text-3xl font-bold text-green-100">Agriculture Media Showcase</h1>
              <p className="text-green-200 text-sm md:text-base">
                Discover innovative farming techniques and agricultural solutions
              </p>
            </div>
              ...
              <Button
                ...
                className={cn(
                  ...
                  activeCategory === null
                    ...
                    : "border-green-500 text-green-200 hover:bg-green-900/50",
                )}
              >
                All
              </Button>
      ...
      <div className="container mx-auto px-4 py-8" ref={containerRef}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVideos.map((video, index) => (
            <div
              key={video.id}
              className="relative bg-gradient-to-b from-green-900/90 to-lime-900/90 rounded-xl overflow-hidden shadow-xl border border-green-600/30 backdrop-blur-sm"
              ref={(el) => {
            ...
            >
              ...
              <div className="relative aspect-[9/16] bg-black">
                ...
                <div className="absolute top-3 left-3 flex flex-col gap-2">
                  ...
                  {video.trending && (
                    <Badge className="bg-lime-500 text-white flex items-center gap-1">
                ...
                <div className="absolute top-3 right-3">
                  <Badge
                    variant="outline"
                    className="border-green-500 text-green-100 bg-black/50 flex items-center gap-1"
                  >
              ...
              <div className="p-4">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1">
                      <h3 className="font-semibold text-green-100 truncate">{video.vendor.name}</h3>
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 text-green-200 hover:text-green-100 hover:bg-green-800/50"
                ...
                <h2 className="font-bold text-green-100 mb-2 line-clamp-2">{video.title}</h2>
                ...
                <AnimatePresence>
                  {showInfo[video.id] ? (
                    ...
                    >
                      <p className="text-sm text-green-200 mb-3">{video.description}</p>

                      {/* Tags */}
                      <div className="flex flex-wrap gap-1 mb-3">
                        {video.tags.map((tag) => (
                          <Badge key={tag} variant="outline" className="text-xs border-green-700 text-green-300">
                      ...
                      {/* Vendor details */}
                      <div className="bg-green-900/50 rounded-lg p-3 mb-3">
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-xs text-green-200">Rating:</span>
                          <div className="flex items-center">
                            ...
                            <span className="ml-1 text-xs text-green-200">
                              {video.vendor.rating.toFixed(1)} ({video.vendor.reviewCount})
                            </span>
                          </div>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-green-200">Followers:</span>
                    ...
                    <p className="text-sm text-green-200 mb-3 line-clamp-2">{video.description}</p>
                  )}
                </AnimatePresence>
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-green-800">
                  <div className="flex items-center gap-3">
                    <Button
                      ...
                      className={cn(
                        ...
                        isLiked[video.id] ? "text-red-500 hover:text-red-600" : "text-green-200 hover:text-green-100",
                      )}
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-8 px-2 text-green-200 hover:text-green-100 flex items-center gap-1"
                    >
                  ...
                  <div className="flex items-center">
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-green-200 hover:text-green-100">
        ...
        {isLoading && (
          <div className="flex justify-center items-center py-8">
            <div className="bg-green-900/80 p-4 rounded-full backdrop-blur-sm flex items-center gap-2">
              ...
              <span className="text-green-200 font-medium">Loading more videos...</span>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="fixed bottom-4 right-4 z-40 flex flex-col gap-2">
        ...
        {/* Mute/unmute button */}
        <button className="bg-green-600 hover:bg-green-700 text-white p-3 rounded-full shadow-lg" onClick={toggleMute}>
