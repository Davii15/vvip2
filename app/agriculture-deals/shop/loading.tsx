...
import { Tractor, Leaf, Wheat, Droplets, Star } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-emerald-50 dark:from-slate-900 dark:to-slate-800 flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              transition={{
                ...
                scale: { duration: 2, repeat: Number.POSITIVE_INFINITY, ease: 'e  ease: "linear' },
        ...
        >
          Loading premium agricultural products and supplies...
        </motion.p>
