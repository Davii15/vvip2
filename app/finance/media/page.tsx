...
export default function FinanceMediaShowcase() {
  useCookieTracking("finance-media")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-800 to-indigo-700">
      {/* Header */}
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <h1 className="text-2xl md:text-3xl font-bold text-indigo-100">Finance Media Showcase</h1>
              <p className="text-indigo-200 text-sm md:text-base">
                Discover expert financial advice and investment strategies
              </p>
            </div>
              ...
              <Button
                ...
                className={cn(
                  ...
                  activeCategory === null
                    ...
                    : "border-indigo-500 text-indigo-200 hover:bg-indigo-900/50",
                )}
              >
                All
              </Button>
      ...
      <div className="container mx-auto px-4 py-8" ref={containerRef}>
            ...
            >
              ...
              <div className="relative aspect-[9/16] bg-black">
                ...
                <div className="absolute top-3 right-3">
                  <Badge
                    variant="outline"
                    className="border-indigo-500 text-indigo-100 bg-black/50 flex items-center gap-1"
                  >
              ...
              <div className="p-4">
                <div className="flex items-start gap-3 mb-3">
                  <Avatar className="h-10 w-10 border-2 border-indigo-500">
                    ...
                    <AvatarFallback className="bg-indigo-800 text-indigo-100">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1">
                      <h3 className="font-semibold text-indigo-100 truncate">{video.vendor.name}</h3>
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 text-indigo-200 hover:text-indigo-100 hover:bg-indigo-800/50"
                ...
                <h2 className="font-bold text-indigo-100 mb-2 line-clamp-2">{video.title}</h2>
                ...
                <AnimatePresence>
                  {showInfo[video.id] ? (
                    ...
                    >
                      <p className="text-sm text-indigo-200 mb-3">{video.description}</p>

                      {/* Tags */}
                      <div className="flex flex-wrap gap-1 mb-3">
                        {video.tags.map((tag) => (
                          <Badge key={tag} variant="outline" className="text-xs border-indigo-700 text-indigo-300">
                      ...
                      <div className="bg-indigo-900/50 rounded-lg p-3 mb-3">
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-xs text-indigo-200">Rating:</span>
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-indigo-200">Followers:</span>
                    ...
                    <p className="text-sm text-indigo-200 mb-3 line-clamp-2">{video.description}</p>
                  )}
                </AnimatePresence>
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-indigo-800">
                  <div className="flex items-center gap-3">
                    <Button
                      ...
                      className={cn(
                        ...
                        isLiked[video.id] ? "text-red-500 hover:text-red-600" : "text-indigo-200 hover:text-indigo-100",
                      )}
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-8 px-2 text-indigo-200 hover:text-indigo-100 flex items-center gap-1"
                    >
                  ...
                  <div className="flex items-center">
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-indigo-200 hover:text-indigo-100">
        ...
        {isLoading && (
          <div className="flex justify-center items-center py-8">
            <div className="bg-indigo-900/80 p-4 rounded-full backdrop-blur-sm flex items-center gap-2">
              <Loader2 className="h-5 w-5 animate-spin text-indigo-300" />
              <span className="text-indigo-200 font-medium">Loading more videos...</span>
            </div>
          </div>
        )}
      </div>
