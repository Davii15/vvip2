...
import { Search, X, Tag, MapPin, Loader2, hammer, TrendingUp , ChevronRight , Sofa , Sparkles} from "lucide-react"
    ...
    <div className="bg-gray-800 rounded-lg shadow-sm overflow-hidden flex flex-col h-full">
      ...
      <div className="p-4 flex-grow flex flex-col">
        ...
        <div className="mt-auto space-y-2">
          ...
          <button className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-2 rounded-full mt-2 hover:from-yellow-500 hover:to-orange-600 transition-all duration-300 shadow-lg animate-pulse min-w-0">
            Check them Out
          </button>
        </div>
      </div>
