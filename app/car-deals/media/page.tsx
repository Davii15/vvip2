...
export default function CarMediaShowcase() {
  useCookieTracking("car-media")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-blue-900 to-indigo-900">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-gradient-to-r from-indigo-950 to-blue-900 border-b border-indigo-800 shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <h1 className="text-2xl md:text-3xl font-bold text-blue-100">Automotive Media Showcase</h1>
              <p className="text-blue-200 text-sm md:text-base">
                Discover the latest automotive videos from top dealers and experts
              </p>
             <Button 
                variant="ghost" 
                size="sm" 
