...
export default function RealEstateMediaShowcase() {
  useCookieTracking("real-estate-media")
 ...
 const [showFilters, setShowFilters] = useState(true)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-sky-800 to-blue-700">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-gradient-to-r from-blue-900 to-sky-800 border-b border-blue-700 shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <h1 className="text-2xl md:text-3xl font-bold text-blue-100">Real Estate Video Showcase</h1>
              <p className="text-blue-200 text-sm md:text-base">
                Explore stunning properties through immersive video tours
              </p>
              <Button 
                variant="ghost" 
                size="sm" 
              ...
              <Button
                ...
                className={cn(
                  ...
                  activeCategory === null
                    ...
                    : "border-blue-500 text-blue-200 hover:bg-blue-900/50",
                )}
              >
                All
              </Button>
      ...
      <div className="container mx-auto px-4 py-8" ref={containerRef}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVideos.map((video, index) => (
            <div
              key={video.id}
              className="relative bg-gradient-to-b from-blue-900/90 to-sky-800/90 rounded-xl overflow-hidden shadow-xl border border-blue-600/30 backdrop-blur-sm"
              ref={(el) => {
            ...
            >
              ...
              <div className="relative aspect-[9/16] bg-black">
                ...
                <div className="absolute top-3 right-3">
                  <Badge
                    variant="outline"
                    className="border-blue-500 text-blue-100 bg-black/50 flex items-center gap-1"
                  >
              ...
              <div className="p-4">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1">
                      <h3 className="font-semibold text-blue-100 truncate">{video.vendor.name}</h3>
                ...
                <h2 className="font-bold text-blue-100 mb-2 line-clamp-2">{video.title}</h2>
                ...
                <AnimatePresence>
                  {showInfo[video.id] ? (
                    ...
                    >
                      <p className="text-sm text-blue-200 mb-3">{video.description}</p>

                      {/* Tags */}
                      <div className="flex flex-wrap gap-1 mb-3">
                        {video.tags.map((tag) => (
                          <Badge key={tag} variant="outline" className="text-xs border-blue-700 text-blue-300">
                      ...
                      {/* Vendor details */}
                      <div className="bg-blue-900/50 rounded-lg p-3 mb-3">
                    ...
                    <p className="text-sm text-blue-200 mb-3 line-clamp-2">{video.description}</p>
                  )}
                </AnimatePresence>
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-blue-800">
                  <div className="flex items-center gap-3">
                    <Button
                      ...
                      className={cn(
                        ...
                        isLiked[video.id] ? "text-red-500 hover:text-red-600" : "text-blue-200 hover:text-blue-100",
                      )}
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-8 px-2 text-blue-200 hover:text-blue-100 flex items-center gap-1"
                    >
                  ...
                  <div className="flex items-center">
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-blue-200 hover:text-blue-100">
        ...
        {isLoading && (
          <div className="flex justify-center items-center py-8">
            <div className="bg-blue-900/80 p-4 rounded-full backdrop-blur-sm flex items-center gap-2">
              ...
              <span className="text-blue-200 font-medium">Loading more videos...</span>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="fixed bottom-4 right-4 z-40 flex flex-col gap-2">
        ...
        {/* Mute/unmute button */}
        <button className="bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full shadow-lg" onClick={toggleMute}>
