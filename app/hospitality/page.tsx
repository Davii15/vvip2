...
export default function HospitalityPage() {
  ...
  // Mock contact data for hospitality vendors
  const vendorContacts = {
    "Serene Skyline Hotel": {
      whatsapp: "+254712345678",
      phone: "+254712345678",
      email: "info@serene-skyline.com",
      website: "https://serene-skyline.com",
    },
    "Cozy Haven Boutique Hotel": {
  ...
  return (
    <div className="bg-gradient-to-br from-red-500 via-amber-400 to-green-500 min-h-screen">
          ...
          <TimeBasedRecommendations
            products={vendors.flatMap((vendor) =>
              vendor.offerings.map((offering) => ({
                ...
                originalPrice: offering.originalPrice,
                category: offering.category,
                recommendedTimes: offering.subcategory?.toLowerCase().includes("breakfast")
                  ? ["morning"]
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center">
                      <Button
                        variant="outline"
                        size="icon"
                        className="h-8 w-8 rounded-l-md border-amber-500 text-amber-200 bg-transparent"
                        onClick={() => {}}
                      >
                      ...
                      <Button
                        variant="outline"
                        size="icon"
                        className="h-8 w-8 rounded-r-md border-amber-500 text-amber-200 bg-transparent"
                        onClick={() => {}}
                      >
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      {selectedOffering.originalPrice.amount !== selectedOffering.currentPrice.amount && (
                        <Button
                          variant="outline"
                          className="border-amber-500 text-amber-200 hover:bg-amber-800/50 flex-1 flex items-center justify-center gap-2 bg-transparent"
                        >
                      ...
                      {/* Modified the "Get a Date" button to open contact modal */}
                      <Button
                        className="bg-gradient-to-r from-amber-500 to-red-500 hover:from-amber-600 hover:to-red-600 text-white flex-1 flex items-center justify-center gap-2"
                        onClick={() => {
                          const vendor = vendors.find((v) => v.offerings.some((o) => o.id === selectedOffering.id))
                          setSelectedContactVendor(vendor?.name || "Hospitality Provider")
      ...
      <Dialog open={showContactModal} onOpenChange={setShowContactModal}>
        <DialogContent className="sm:max-w-md bg-gradient-to-br from-slate-900 to-amber-900 border-amber-500/30">
          <div className="p-6">
            <div className="text-center mb-6">
              <div className="mx-auto w-16 h-16 bg-gradient-to-r from-amber-500 to-red-600 rounded-full flex items-center justify-center mb-4">
                <Phone className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">Contact {selectedContactVendor}</h3>
              <p className="text-amber-200">Choose your preferred way to get in touch</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* WhatsApp */}
              <motion.a
                href={`https://wa.me/${vendorContacts[selectedContactVendor as keyof typeof vendorContacts]?.whatsapp?.replace("+", "") || "254700000000"}?text=Hi, I'm interested in your hospitality services`}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <motion.a
                ...
                className="flex items-center justify-center gap-3 p-4 bg-amber-600 hover:bg-amber-700 text-white rounded-lg transition-all duration-200 shadow-lg"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
              ...
              {/* Email */}
              <motion.a
                href={`mailto:${vendorContacts[selectedContactVendor as keyof typeof vendorContacts]?.email || "info@hospitality.co.ke"}?subject=Hospitality Inquiry&body=Hi, I'm interested in your hospitality services and would like more information.`}
                className="flex items-center justify-center gap-3 p-4 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-all duration-200 shadow-lg"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
              ...
              <motion.a
                href={
                  ...
                  "https://hospitality.co.ke"
                }
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 p-4 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-all duration-200 shadow-lg"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
            ...
            <div className="mt-6 text-center">
              <Button
                ...
                className="border-amber-500 text-amber-300 hover:bg-amber-800/50"
              >
                Close
              </Button>
            </div>
